...
<div class="w-full max-w-screen-xl mx-auto">
    ...
    <form method="POST" action="{{ route('suppliers.update', $supplier->id) }}" class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="cnpj" id="cnpj" placeholder="00.000.000/0000-00" class="w-full pl-10 pr-12 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-800 bg-gray-50 text-sm" required value="{{ $supplier->cnpj }}">
            ...
            <div class="sm:col-span-2 lg:col-span-3 xl:col-span-4">
                ...
                <input type="text" name="name" id="name" placeholder="Nome do fornecedor" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-800 bg-gray-50 text-sm" required value="{{ $supplier->name }}">
            </div>
            <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <div>
                <label class="block text-sm text-gray-700 font-medium mb-1">Nome</label>
                <input type="text" name="contact_name" id="contact_name" placeholder="Nome do contato" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-800 bg-gray-50 text-sm" required value="{{ $supplier->contact_name }}">
            </div>
            <div>
                <label class="block text-sm text-gray-700 font-medium mb-1">E-mail</label>
                <input type="email" name="contact_email" id="contact_email" placeholder="email@exemplo.com" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-800 bg-gray-50 text-sm" required value="{{ $supplier->contact_email }}">
            </div>
            <div>
                <label class="block text-sm text-gray-700 font-medium mb-1">Telefone</label>
                <input type="text" name="contact_phone" id="contact_phone" placeholder="(99) 99999-9999" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-800 bg-gray-50 text-sm" required value="{{ $supplier->contact_phone }}">
            </div>
            <div>
                <label class="block text-sm text-gray-700 font-medium mb-1">Site</label>
                <input type="text" name="contact_site" id="contact_site" placeholder="www.exemplo.com" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-800 bg-gray-50 text-sm" value="{{ $supplier->contact_site }}">
            </div>
        </div>
        <div class="sm:col-span-2 lg:col-span-3 xl:col-span-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <div>
                ...
                <input type="text" name="cep" id="cep" placeholder="00000-000" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-800 bg-gray-50 text-sm" required value="{{ $supplier->cep }}">
            </div>
            <div>
                <label class="block text-sm text-gray-700 font-medium mb-1">Endereço</label>
                <input type="text" name="address" id="address" placeholder="Rua, avenida..." class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-800 bg-gray-50 text-sm" required value="{{ $supplier->address }}">
            </div>
            <div>
                <label class="block text-sm text-gray-700 font-medium mb-1">Número</label>
                <input type="text" name="number" id="number" placeholder="Número" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-800 bg-gray-50 text-sm" required value="{{ $supplier->number }}">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" name="neighborhood" id="neighborhood" placeholder="Bairro" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-800 bg-gray-50 text-sm" required value="{{ $supplier->neighborhood }}">
            </div>
            <div>
                <label class="block text-sm text-gray-700 font-medium mb-1">Estado</label>
                <input type="text" name="state" id="state" placeholder="Estado" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-800 bg-gray-50 text-sm" required value="{{ $supplier->state }}">
            </div>
            <div>
                <label class="block text-sm text-gray-700 font-medium mb-1">Cidade</label>
                <input type="text" name="city" id="city" placeholder="Cidade" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-800 bg-gray-50 text-sm" required value="{{ $supplier->city }}">
            </div>
            <div>
                <label class="block text-sm text-gray-700 font-medium mb-1">País</label>
                <input type="text" name="country" id="country" placeholder="Brasil" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-800 bg-gray-50 text-sm" required value="{{ $supplier->country }}">
            </div>
        </div>
